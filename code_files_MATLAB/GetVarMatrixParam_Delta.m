...
function [V]=GetVarMatrixParam_Delta(ConsGrowth,param)
myDelta=1e-15*abs(param);

% First Derivative calculation
[sumloglik,logLikVec1]=LikelihoodFunc_Delta(ConsGrowth,param);
n=length(logLikVec1); 
...
for i=1:numel(param)
 ...
 [sumloglik,logLikVec2]=LikelihoodFunc_Delta(ConsGrowth,vec);
