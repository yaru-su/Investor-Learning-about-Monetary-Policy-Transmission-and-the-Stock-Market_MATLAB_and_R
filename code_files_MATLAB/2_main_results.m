...
disp(paramdelta_std);
disp('T-Statistics:');
disp(paramdelta_tstats);
disp('P-Values:');
disp(paramdelta_pvalues);
...
% Display estimated parameters and their statistics
disp('Estimated Parameters for Output Gap:');
disp(paramy);
disp('Standard Errors for Output Gap:');
disp(paramy_std);
disp('T-Statistics for Output Gap:');
disp(paramy_tstats);
disp('P-Values for Output Gap:');
disp(paramy_pvalues);
