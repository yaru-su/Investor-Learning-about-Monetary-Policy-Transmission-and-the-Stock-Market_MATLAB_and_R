...
%        results.meth  = 'newlyw'
%        results.beta  = bhat
%        results.varianceBeta = variance of parameters
...
results.CovMatBeta=V;
results.varianceBeta=nwerr.^2;  
results.tstat = results.beta./nwerr; % Newey-West t-statistics
results.pval = 2*(1-tcdf(abs(results.tstat),nobs-nvar)); % Newey-West t-statistics
