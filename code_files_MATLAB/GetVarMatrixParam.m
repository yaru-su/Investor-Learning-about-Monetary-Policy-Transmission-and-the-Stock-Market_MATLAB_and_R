...
function [V]=GetVarMatrixParam(inflation,fedfund,param)
myDelta=1e-15*abs(param);

% First Derivative calculation
[sumloglik,logLikVec1]=LikelihoodFunc(inflation,fedfund,param);
n=length(logLikVec1); 
...
for i=1:numel(param)
 ...
 [sumloglik,logLikVec2]=LikelihoodFunc(inflation,fedfund,vec);
